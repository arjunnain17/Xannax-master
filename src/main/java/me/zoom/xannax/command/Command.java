...
public abstract class Command {
    ...
    public static void sendClientMessage(String message){
            if (MsgWaterMark)
                mc.player.sendMessage(new TextComponentString(ClickGuiModule.getBrackets() + "[" + ClickGuiModule.getTextColor() + "XannaX" + ClickGuiModule.getBrackets() + "] " + ChatFormatting.RESET + cf + message));
            else
