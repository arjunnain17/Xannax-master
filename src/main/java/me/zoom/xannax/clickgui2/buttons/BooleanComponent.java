...
public class BooleanComponent extends Component {
	...
	public void renderComponent(){
		...
		FontUtils.drawStringWithShadow(ModuleManager.isModuleEnabled("CustomFont"), this.op.getName(),this.parent.parent.getX() + centeredNameCoords, this.parent.parent.getY() + this.offset + 2, Renderer.getFontColor(true, 0).getRGB());
	}
