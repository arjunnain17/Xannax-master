...
import me.zoom.xannax.clickgui2.buttons.*;
...
//			if (comp instanceof ColorComponent) opY+=60;
	...
	public void renderComponent() {
		if (this.mod.isEnabled()){
			...
			Renderer.renderImage(this.parent.getX(), this.parent.getY() + this.offset+ this.parent.scrolloff, this.parent.getX(), this.parent.getY() + this.offset + this.parent.getRainbowOffset()+ this.parent.scrolloff, this.parent.getWidth(), 12, 1920f, 1080f);
		...
		drawOpenRender(this.parent.getX() + this.parent.getWidth() - 12, this.parent.getY() + this.offset + 2+ this.parent.scrolloff);

		if (isMouseOnButton(this.parent.getMouseX(), this.parent.getMouseY()+ this.parent.scrolloff) && !(this.mod.getDescription()==null)){
