...
public class XannaxRPC {
    ...
    public static void init() {
        ...
        presence.details = Xannax.MOD_NAME + Xannax.VERSION;
        presence.state = "vibin'";
        presence.largeImageKey = "large";
        presence.largeImageText = Xannax.MOD_NAME + " " + Xannax.VERSION;
        ...
        new Thread(() -> {
            while (!Thread.currentThread().isInterrupted()) {
                try {
                    ...
                    details = Xannax.MOD_NAME + Xannax.VERSION;
                    state = "vibin'";
