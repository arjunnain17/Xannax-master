...
import java.awt.*;
import static me.zoom.xannax.module.modules.client.HUD.arraySat;
import static me.zoom.xannax.module.modules.client.HUD.arrayBri;
...
public class RainbowUtil {
    ...
    public static int rainbow(int delay) {
        ...
        rainbowState %= 360;
        return Color.getHSBColor((float) (rainbowState / 360.0f), (float)arraySat.getValue() / 100, (float)arrayBri.getValue() / 100).getRGB();
    }
