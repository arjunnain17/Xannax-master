...
public class Speed extends Module
{
    ...
    public void setup() {
        ...
        modes.add("NCP");
        modes.add("Strafe");
        this.mode = registerMode("Mode", "Mode", modes, "NCP");
        this.limiter = registerBoolean("SetGround", "SetGround", true);
        this.limiter2 = registerBoolean("Bhop", "Bhop", false);
        this.specialMoveSpeed = registerInteger("Speed", "Speed", 100, 0, 150);
        this.potionSpeed = registerInteger("Speed1", "Speed1", 130, 0, 150);
        this.potionSpeed2 = registerInteger("Speed2", "Speed2", 125, 0, 150);
        this.acceleration = registerInteger("Accel", "Accel", 2149, 1000, 2500);
        this.potion = registerBoolean("Potion", "Potion", false);
        this.step = registerBoolean("SetStep", "SetStep", true);
    ...
    public void onMove(final MoveEvent event) {
        ...
        else if (mode.getValue().equalsIgnoreCase("Strafe")) {
