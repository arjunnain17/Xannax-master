...
import static me.zoom.xannax.util.BlockUtils.canBeClicked;
import static me.zoom.xannax.util.BlockUtils.faceVectorPacketInstant;

public class AutoTrap extends Module{
    public AutoTrap(){
        super("AutoTrap", "AutoTrapX", Category.Combat);
    }
    ...
    public String getHudInfo() {
        if (closestTarget != null) {
            return "[" + ChatFormatting.WHITE + closestTarget.getName() + ChatFormatting.GRAY + "]";
        } else {
