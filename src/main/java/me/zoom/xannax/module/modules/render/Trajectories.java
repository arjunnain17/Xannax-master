...
public class Trajectories extends Module
{
    ...
    public void setup(){
        redt = registerInteger("Red", "RedT", 255, 0, 255);
        greent = registerInteger("Green", "GreenT", 255, 0, 255);
        bluet = registerInteger("Blue", "BlueT", 255, 0, 255);
    }
    ...
    public void onWorldRender(final RenderEvent event) {
        ...
        if (power > 0.6f) {
            GlStateManager.color((float)redt.getValue()/255, (float)greent.getValue()/255, (float)bluet.getValue()/255, 1.0f);
        }
        else {
            GlStateManager.color((float)redt.getValue()/255, (float)greent.getValue()/255, (float)bluet.getValue()/255, 1.0f);
        }
